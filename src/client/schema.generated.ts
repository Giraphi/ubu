...
/** Input for the createGig mutation */
...
/** Input for the deleteGig mutation */
export interface DeleteGigInput {
  /** This is an ID that can be passed to a mutation by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: InputMaybe<Scalars["String"]>;
  /** Whether the object should be force deleted instead of being moved to the trash */
  forceDelete?: InputMaybe<Scalars["Boolean"]>;
  /** The ID of the Gig to delete */
  id: Scalars["ID"];
}
...
export enum MediaItemSizeEnum {
  ...
  /** MediaItem with the shapely-featured size */
  SHAPELY_FEATURED = "SHAPELY_FEATURED",
  /** MediaItem with the shapely-full size */
  SHAPELY_FULL = "SHAPELY_FULL",
  /** MediaItem with the shapely-grid size */
  SHAPELY_GRID = "SHAPELY_GRID",
...
/** Arguments for filtering the RootQueryToGigConnection connection */
export interface RootQueryToGigConnectionWhereArgs {
  /** Filter the connection based on dates */
  dateQuery?: InputMaybe<DateQueryInput>;
  /** True for objects with passwords; False for objects without passwords; null for all objects with or without passwords */
  hasPassword?: InputMaybe<Scalars["Boolean"]>;
...
/** Input for the updateGig mutation */
export interface UpdateGigInput {
  /** This is an ID that can be passed to a mutation by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: InputMaybe<Scalars["String"]>;
  /** The date of the object. Preferable to enter as year/month/day (e.g. 01/31/2017) as it will rearrange date as fit if it is not specified. Incomplete dates may have unintended results for example, "2017" as the input will use current date with timestamp 20:17  */
  date?: InputMaybe<Scalars["String"]>;
  /** The ID of the Gig object */
  id: Scalars["ID"];
  /** A field used for ordering posts. This is typically used with nav menu items or for special ordering of hierarchical content types. */
  menuOrder?: InputMaybe<Scalars["Int"]>;
  /** The password used to protect the content of the object */
...
export const generatedSchema = {
  ...
  Gig: {
    ...
    modified: { __type: "String" },
    modifiedGmt: { __type: "String" },
    preview: { __type: "GigToPreviewConnectionEdge" },
    previewRevisionDatabaseId: { __type: "Int" },
    previewRevisionId: { __type: "ID" },
    slug: { __type: "String" },
    status: { __type: "String" },
  ...
  RootQueryToGigConnection: {
    __typename: { __type: "String!" },
    edges: { __type: "[RootQueryToGigConnectionEdge]" },
    nodes: { __type: "[Gig]" },
    pageInfo: { __type: "WPPageInfo" },
  },
  RootQueryToGigConnectionEdge: {
    __typename: { __type: "String!" },
    cursor: { __type: "String" },
    node: { __type: "Gig" },
  },
  RootQueryToGigConnectionWhereArgs: {
    dateQuery: { __type: "DateQueryInput" },
    hasPassword: { __type: "Boolean" },
    id: { __type: "Int" },
    in: { __type: "[ID]" },
  ...
  Template_SidebarLeft: {
    __typename: { __type: "String!" },
    templateName: { __type: "String" },
  },
  Template_SidebarRight: {
    __typename: { __type: "String!" },
    templateName: { __type: "String" },
  },
  TermNode: {
  ...
  mutation: {
    ...
    createGig: {
      __type: "CreateGigPayload",
      __args: { input: "CreateGigInput!" },
    },
    createMediaItem: {
    ...
    deleteGig: {
      __type: "DeleteGigPayload",
      __args: { input: "DeleteGigInput!" },
    },
    deleteMediaItem: {
    ...
    updateGig: {
      __type: "UpdateGigPayload",
      __args: { input: "UpdateGigInput!" },
    },
    updateMediaItem: {
  ...
  query: {
    ...
    gig: {
      __type: "Gig",
      __args: { asPreview: "Boolean", id: "ID!", idType: "GigIdType" },
    },
    gigBy: {
      __type: "Gig",
      __args: { gigId: "Int", id: "ID", slug: "String", uri: "String" },
    },
    gigs: {
      __type: "RootQueryToGigConnection",
      __args: {
        after: "String",
        before: "String",
        first: "Int",
        last: "Int",
        where: "RootQueryToGigConnectionWhereArgs",
      },
    },
    mediaItem: {
      __type: "MediaItem",
  ...
  [SchemaUnionsKey]: {
    ...
    MenuItemLinkable: ["Category", "Gig", "Page", "Post", "Tag"],
    Node: [
      "Category",
      "Comment",
      "CommentAuthor",
    ...
    ContentNode: ["Gig", "MediaItem", "Page", "Post"],
    NodeWithTemplate: ["Gig", "MediaItem", "Page", "Post"],
    NodeWithTitle: ["Gig", "MediaItem", "Page", "Post"],
    AcfFieldGroup: ["Gig_Gig"],
    HierarchicalContentNode: ["MediaItem", "Page"],
    NodeWithAuthor: ["MediaItem", "Page", "Post"],
    NodeWithComments: ["MediaItem", "Page", "Post"],
    MenuItemObjectUnion: ["Category", "Gig", "Page", "Post", "Tag"],
...
export interface ContentNode {
  __typename?: "Gig" | "MediaItem" | "Page" | "Post";
  /**
   * @deprecated Deprecated in favor of using Next.js pages
   */
  conditionalTags?: Maybe<ConditionalTags>;
...
/**
 * The payload for the createGig mutation
 */
export interface CreateGigPayload {
  __typename?: "CreateGigPayload";
  /**
   * If a &#039;clientMutationId&#039; input is provided to the mutation, it will be returned as output on the mutation. This ID can be used by the client to track the progress of mutations and catch possible duplicate mutation submissions.
   */
  clientMutationId?: Maybe<ScalarsEnums["String"]>;
...
/**
 * The payload for the deleteGig mutation
 */
export interface DeleteGigPayload {
  __typename?: "DeleteGigPayload";
  /**
   * If a &#039;clientMutationId&#039; input is provided to the mutation, it will be returned as output on the mutation. This ID can be used by the client to track the progress of mutations and catch possible duplicate mutation submissions.
   */
  clientMutationId?: Maybe<ScalarsEnums["String"]>;
...
export interface Gig {
  ...
  /**
   * Added to the GraphQL Schema because the ACF Field Group &quot;Gig&quot; was set to Show in GraphQL.
   */
  gig?: Maybe<Gig_Gig>;
  /**
   * The id field matches the WP_Post-&gt;ID field.
   ...
   */
  gigId: ScalarsEnums["Int"];
  /**
   * The global unique identifier for this post. This currently matches the value stored in WP_Post-&gt;guid and the guid column in the &quot;post_objects&quot; database table.
   */
  guid?: Maybe<ScalarsEnums["String"]>;
  /**
   * The globally unique identifier of the gig object.
   */
  id: ScalarsEnums["ID"];
  /**
   * Whether the node is a Content Node
  ...
  modifiedGmt?: Maybe<ScalarsEnums["String"]>;
  /**
   * Connection between the Gig type and the Gig type
   */
  preview?: Maybe<GigToPreviewConnectionEdge>;
  /**
   * The database id of the preview node
   */
  previewRevisionDatabaseId?: Maybe<ScalarsEnums["Int"]>;
 ...
 * Connection between the Gig type and the Gig type
 */
export interface GigToPreviewConnectionEdge {
  __typename?: "GigToPreviewConnectionEdge";
  /**
   * The node of the connection, without the edges
   */
  node?: Maybe<Gig>;
...
export interface Gig_Gig {
   ...
   */
  fieldGroupName?: Maybe<ScalarsEnums["String"]>;
  headline?: Maybe<ScalarsEnums["String"]>;
...
export interface MenuItemLinkable {
  __typename?: "Category" | "Gig" | "Page" | "Post" | "Tag";
  /**
   * The unique resource identifier path
   */
  databaseId: ScalarsEnums["Int"];
...
/**
 * Connection between the RootQuery type and the Gig type
 */
export interface RootQueryToGigConnection {
  __typename?: "RootQueryToGigConnection";
  /**
   * Edges for the RootQueryToGigConnection connection
   */
  edges?: Maybe<Array<Maybe<RootQueryToGigConnectionEdge>>>;
  /**
   * The nodes of the connection, without the edges
   */
  nodes?: Maybe<Array<Maybe<Gig>>>;
  /**
   * Information about pagination in a connection.
   */
  pageInfo?: Maybe<WPPageInfo>;
 ...
 * An edge in a connection
 */
export interface RootQueryToGigConnectionEdge {
  __typename?: "RootQueryToGigConnectionEdge";
  /**
   * A cursor for use in pagination
   */
  cursor?: Maybe<ScalarsEnums["String"]>;
 ...
 * The template assigned to the node
 */
export interface Template_BuilderPage {
  __typename?: "Template_BuilderPage";
  /**
   * The name of the template
   */
  templateName?: Maybe<ScalarsEnums["String"]>;
 ...
 * The template assigned to the node
 */
export interface Template_NoSidebar {
  __typename?: "Template_NoSidebar";
  /**
   * The name of the template
   */
  templateName?: Maybe<ScalarsEnums["String"]>;
 ...
 * The template assigned to the node
 */
export interface Template_SidebarLeft {
  __typename?: "Template_SidebarLeft";
  /**
   * The name of the template
   */
  templateName?: Maybe<ScalarsEnums["String"]>;
 ...
 * The template assigned to the node
 */
export interface Template_SidebarRight {
  __typename?: "Template_SidebarRight";
  /**
   * The name of the template
   */
  templateName?: Maybe<ScalarsEnums["String"]>;
...
/**
 * The payload for the updateGig mutation
 */
export interface UpdateGigPayload {
  __typename?: "UpdateGigPayload";
  /**
   * If a &#039;clientMutationId&#039; input is provided to the mutation, it will be returned as output on the mutation. This ID can be used by the client to track the progress of mutations and catch possible duplicate mutation submissions.
   */
  clientMutationId?: Maybe<ScalarsEnums["String"]>;
...
export interface Mutation {
  ...
  createGig: (args: { input: CreateGigInput }) => Maybe<CreateGigPayload>;
  ...
  deleteGig: (args: { input: DeleteGigInput }) => Maybe<DeleteGigPayload>;
  ...
  updateGig: (args: { input: UpdateGigInput }) => Maybe<UpdateGigPayload>;
...
export interface Query {
  ...
  gigs: (args?: {
    ...
    first?: Maybe<Scalars["Int"]>;
    last?: Maybe<Scalars["Int"]>;
    where?: Maybe<RootQueryToGigConnectionWhereArgs>;
  }) => Maybe<RootQueryToGigConnection>;
  mediaItem: (args: {
    asPreview?: Maybe<Scalars["Boolean"]>;
    id: Scalars["ID"];
...
export interface SchemaObjectTypes {
  ...
  CreateGigPayload: CreateGigPayload;
  ...
  DeleteGigPayload: DeleteGigPayload;
  ...
  Gig: Gig;
  GigToPreviewConnectionEdge: GigToPreviewConnectionEdge;
  Gig_Gig: Gig_Gig;
  ...
  RootQueryToGigConnection: RootQueryToGigConnection;
  RootQueryToGigConnectionEdge: RootQueryToGigConnectionEdge;
  ...
  Template_BuilderPage: Template_BuilderPage;
  Template_FullWidth: Template_FullWidth;
  Template_HomePage: Template_HomePage;
  Template_NoSidebar: Template_NoSidebar;
  Template_SidebarLeft: Template_SidebarLeft;
  Template_SidebarRight: Template_SidebarRight;
  ...
  UpdateGigPayload: UpdateGigPayload;
