...
export default function Gigs(props: GigsProps) {
  const pastGigs = (
    <ul className={"flex flex-col gap-2 md:gap-1"}>
      <li>
        <a target={"_blank"} href={"https://www.horstklub.ch/"}>
          20.07.24 Horst Club, Kreuzlingen CH
        </a>
      </li>

      <li>
        <a target={"_blank"} href={" https://shedhalle.de/de/events/konzert-hut-ubu-imperator"}>
          19.07.24 Shedhalle, Tübingen
        </a>
      </li>

      <li>
        <a target={"_blank"} href={"https://www.glockenbachwerkstatt.de/"}>
          18.07.24 Glockbachwerkstatt, München
        </a>
      </li>
      <li>
        <a target={"_blank"} href={"https://www.lenbachhaus.de/"}>
          15.07.24 Lenbachhaus / Fashion Performance, München
        </a>
      </li>
      <li>
        <a target={"_blank"} href={"https://www.instagram.com/treibhaus_acts/"}>
          23.02.24 Treibhaus, München
        </a>
      </li>
      <li>
        <a target={"_blank"} href={"https://moodclub.org/programm/"}>
          16.12.23 Mood Club, Memmingen
        </a>
      </li>
      <li>
        <a target={"_blank"} href={"https://www.instagram.com/p/CzttGAfCXgs/?img_index=1"}>
      ...
      <Grid>
        <CompactArea>
          ...
          <ul className={"flex flex-col gap-2 pb-8 md:gap-1"}>
            ...
            <li>
              <a target={"_blank"} href={"https://www.facebook.com/events/1015451419730315"}>
            ...
            <li>
              <a target={"_blank"} href={"https://aera.at/"}>
            ...
            <li>
              <a target={"_blank"} href={"https://www.schokoladen-mitte.de/"}>
                26.07.24 Schokoladen, Berlin
              </a>
            </li>
            <li>
              <a target={"_blank"} href={"http://www.c-keller.de/"}>
